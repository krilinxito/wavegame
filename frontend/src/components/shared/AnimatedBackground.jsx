...
const BLOBS = [
  { left: '8%',  top: '12%', size: 380, color: '#b83820', opacity: 0.32, yDur: 9,  xDur: 23, delay: 0,   xRange: 28  },
  { left: '70%', top: '8%',  size: 300, color: '#7a4200', opacity: 0.30, yDur: 11, xDur: 29, delay: 2,   xRange: -22 },
  { left: '80%', top: '65%', size: 420, color: '#b83820', opacity: 0.28, yDur: 13, xDur: 31, delay: 4,   xRange: 18  },
  { left: '15%', top: '70%', size: 260, color: '#c84a00', opacity: 0.34, yDur: 8,  xDur: 25, delay: 1.5, xRange: -30 },
  { left: '48%', top: '40%', size: 200, color: '#7a4200', opacity: 0.26, yDur: 10, xDur: 27, delay: 3.5, xRange: 24  },
];
